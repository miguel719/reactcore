...
## Creating new Screen
- The screens are contained in separated files, in the folder ./src/, ex Login.js
- To create new Screen create the file in PascalCase and add the filename in constants.js in screens.{component: "MyScreen", title:"My Screen"}
- The title will appear in the app bar in there is not title
...
## Build
- npm run build
- For some reason to test local de href="/... redirect to href="C:/ so you need to put point befor the path href="./...
